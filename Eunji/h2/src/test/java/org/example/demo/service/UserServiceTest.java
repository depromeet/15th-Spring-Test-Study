...
public class UserServiceTest {
    ...
    void getById는_ACTIVE_상태인_유저를_찾아올_수_있다() {
        // given
        // when
        UserEntity result = userService.getById(10);
    ...
    void userUpdateDto_를_이용하여_유저를_수정할_수_있다() {
        ...
        // when
        userService.update(10, userUpdateDto);

        // then
        UserEntity userEntity = userService.getById(10);
    ...
    void PENDING_상태의_사용자는_인증_코드로_ACTIVE_시킬_수_있다() {
        // given
        // when
        userService.verifyEmail(20, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab");

        // then
        UserEntity userEntity = userService.getById(20);
    ...
    void PENDING_상태의_사용자는_잘못된_인증_코드를_받으면_에러를_던진다() {
        ...
        // then
        assertThatThrownBy(() -> {
            userService.verifyEmail(20, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac");
