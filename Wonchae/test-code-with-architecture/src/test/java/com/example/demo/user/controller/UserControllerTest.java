...
public class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_개인정보는_소거된채_전달_받을_수_있다() {
        ...
        Assertions.assertThat(result.getBody().getEmail()).isEqualTo("kok202@naver.com");
        Assertions.assertThat(result.getBody().getNickname()).isEqualTo("kok202");
        Assertions.assertThat(result.getBody().getLastLoginAt()).isEqualTo(100L);
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다() {
        ...
        Assertions.assertThat(testContainer.userRepository.getById(1).getStatus()).isEqualTo(UserStatus.ACTIVE);
    }
    ...
    void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갖고_올_수_있다() {
        ...
        Assertions.assertThat(result.getBody().getEmail()).isEqualTo("kok202@naver.com");
        Assertions.assertThat(result.getBody().getNickname()).isEqualTo("kok202");
        Assertions.assertThat(result.getBody().getLastLoginAt()).isEqualTo(1678530673958L);
    ...
    void 사용자는_내_정보를_수정할_수_있다() {
        ...
        Assertions.assertThat(result.getBody()).isNotNull();
        Assertions.assertThat(result.getBody().getEmail()).isEqualTo("kok202@naver.com");
        Assertions.assertThat(result.getBody().getNickname()).isEqualTo("kok202-n");
        Assertions.assertThat(result.getBody().getLastLoginAt()).isEqualTo(100L);
